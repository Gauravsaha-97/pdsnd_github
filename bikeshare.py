...
def choice(prompt, choices=('y', 'n')):
    ...
    while True:
        ...
        prompt = ("\nSomething seems to be wrong!! Please do the formatting and "
                  "be sure not to enter an invalid option:\n>")
...
def get_filters():
    ...
    print("Type end at any time if you would like to close or exit from the program.\n")
